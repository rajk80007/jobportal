<div>
@if($errmessage)
<h1 class="text-red-500 text-center text-2xl font-bold flex justify-center items-center bg-white w-full">{{$errmessage}} <span class="text-red-500 cursor-pointer border-2 border-red-500 px-2 rounded-md mx-2 text-md hover:bg-red-500 hover:text-white" wire:click="close">X</span> </h1>
@elseif($message)
<h1 class="text-green-500 text-center text-2xl font-bold flex justify-center items-center bg-white w-full">{{$message}} <span class="text-green-500 cursor-pointer border-2 border-green-500 px-2 rounded-md mx-2 text-md hover:bg-green-500 hover:text-white" wire:click="close">X</span> </h1>
@endif
<div class="w-full px-2 md:w-[95%] grid grid-cols-2 mx-auto h-full lg:h-[70vh] my-2">
    ...
    <div
        ...
        <form action="#" wire:submit.prevent="register"
            ...
            <p class="text-white">Already have an account? <a href="/login/{{ 3 }}"
